...
const ROWS: &[Row] = &[
    ...
    Row::Bind("Tab / Shift+Tab", "cycle lenses forward / backward"),
    Row::Bind("1-7", "jump to a lens directly (see the tab bar numbers)"),
    Row::Bind("b", "jump to Blocks & Locks Lens"),
    Row::Bind("Backspace", "back to the previously active lens"),
    Row::Bind("j / \u{2193}, k / \u{2191}", "move selection down / up"),
    Row::Bind("g/Home, G/End", "jump selection to the first / last row"),
    ...
    Row::Bind("/", "filter (Micro Activity/Schema Tables/Query Lens)"),
    ...
    Row::Bind("y", "copy selection to clipboard, OSC 52 (Micro/Query/Index/Blocks)"),
    Row::Bind("?", "this help"),
