...
use crate::models::{
    ...
    PreparedXactRow, PublicationRow, ReplicationSlotRow, SequenceRow, StatementRow,
    SubscriptionRow, TableDetailColumn, TableDetailConstraint, TableDetailIndex, TableStatRow,
...
pub async fn configure_named_session(
    client: &Client,
    name: &str,
...
pub fn active_lock_from_row(row: &Row) -> Result<ActiveLockRow, tokio_postgres::Error> {
    Ok(ActiveLockRow {
        ...
        duration_secs: row
            .try_get::<_, Option<f64>>("duration_secs")?
            .unwrap_or(0.0),
